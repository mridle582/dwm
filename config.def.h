...
static const int usealtbar          = 1; /* 1 = do not use dwm's status bar*/
...
static const char *fonts[]          = { "SauceCodePro:size=11" };
static const char dmenufont[]       = "SauceCodePro:size=11";
...
static const char *scrotcmd[]  = { "sleep", "0.2;", "scrot", "-s", "-f", "~/Pictures/screenshots/%Y-%m-%d-%T-screenshot.png", NULL };
